...
def get_imdbid(final_output_senti):
    prompt = f"""
You are an imdb id appender.

Given the dictionary of movie recommendations, remove everything else and just return imdb ids seperated by spaces.
Dict: "{final_output_senti}"
